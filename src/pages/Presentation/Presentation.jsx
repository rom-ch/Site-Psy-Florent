...
function Presentation() {
  ...
  useEffect(() => {
    document.title = "Qui suis-je ? | Florent Chauvin"
  }, [])
      ...
      <main className="main">
        <div className={styles["first-paragraph"]}>
          ...
          <div className={styles["first-paragraph-content"]}>
            <p>
              ...
              les patients au centre de ma pratique pour réussir à les guider du
              mieux que je peux. Je pratique actuellement le mercredi et le
              ...
              j&apos;accompagne dans leur vie, notamment avec leur famille et à
              l&apos;école.
            </p>
          </div>
        </div>
        <div className={styles.paragraph}>
          <p>
            ...
            l&apos;humain, un objectif de développement et d&apos;épanouissement
            personnels pour celles et ceux qui peuvent sentir des blocages dans
            leur vie. Par le dialogue, je souhaite découvrir l&apos;univers de
            la personne que je rencontre et, dans la mesure du possible,
            comprendre sa problématique, lui permettre de prendre du recul sur
            ce qu&apos;elle vit et lui donner des pistes pour continuer dans la
            découverte d&apos;elle-même. Utilisant également une{" "}
            <a
            ...
            , c&apos;est-à-dire ne basant pas ma pratique uniquement sur un seul
            courant de pensée, je peux utiliser des éléments de la{" "}
            <a
          ...
          <p>
            ...
            médiations tels que les jeux, les dessins, la pâte à modeler afin de
            les aider à exprimer des pensées ou des émotions. Je réalise
            ...
            intellectuel ou affectif. Vous trouverez plus d&apos;information sur
            la page <Link to={"/ma-pratique"}>Ma pratique</Link> si vous
