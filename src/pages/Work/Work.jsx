...
function Work() {
  ...
  useEffect(() => {
    document.title = "Ma pratique | Florent Chauvin";
  }, [])
          ...
          <div className={styles.age}>
            ...
            <div className={styles["age-content"]}>
              ...
              <p>
                ...
                général, font remonter le problème. Je reçois toujours
                l&apos;enfant avec les parents durant le premier entretien car
                ils seront acteurs également dans le processus de compréhension
                de ce qui ne va pas. Par la suite, nous échangeons régulièrement
                ensemble et parfois sans l&apos;enfant en fonction de ce que
                j&apos;observe de l&apos;enfant et de sa problématique. Lors des
                séances avec les enfants, j&apos;utilise les jeux, le dessin et
                la parole pour qu&apos;ils arrivent à exprimer ce qu&apos;ils
                ressentent. Je reçois également des enfants avec les parents (ou
                l&apos;un des deux) lorsqu&apos;il faut travailler sur la
          ...
          <div className={styles.age}>
            ...
            <div className={styles["age-content"]}>
              ...
              <p>
                ...
                des cas, les parents se sentent démunis face à leur enfant. La
                possibilité de les intégrer dans le processus thérapeutique
                dépendra de la volonté de l&apos;adolescent et de la
          ...
          <div className={styles.age}>
            ...
            <div className={styles["age-content"]}>
              ...
              <p>
                ...
                externe comme les relations aux autres. La thérapie,
                ...
                parcours de vie de la personne. Pour certains, cette connexion
                peut se faire rapidement mais le travail se déroule en général
                sur plusieurs mois.
              </p>
            </div>
          </div>
